...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-950 border-t border-slate-900 py-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-2xl font-black tracking-tight text-white">LUMINA</span>
          </div>
          <p className="text-slate-500 leading-relaxed mb-6">
            Revolutionizing the intersection of artificial intelligence and creative design workflows. Built for the modern team.
          </p>
          <div className="flex gap-4">
            {/* Social icons placeholders */}
            <div className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-slate-800 transition-colors cursor-pointer border border-slate-800">
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-slate-900 text-center text-slate-600 text-sm">
        © 2024 Lumina AI Technologies Inc. All rights reserved.
      </div>
    </footer>
  );
};
